      ...
      for j in xrange(i+1,len(f)+1):
        ...
        for l in range(i+1, j):
        	if f[i:l] in tm and f[l:j] in tm:
        		#Notice that phrase1 is after phrase2 in the English Sentence
        		#Therefore predecessor phrase1 should be phrase2
        		for phrase1 in tm[f[i:l]]:
        			for phrase2 in tm[f[l:j]]:
        				# if i ==1 and j ==4 and l==2:
        				#     print f[i:l], phrase1
        				#     print f[l+1:j], phrase2
        				# if phrase2 == 'selection' and phrase1 == 'committee':
        				# 	print "!"
                        ...
                        # This hypothesis should not be stored, just leave it here
                        # stacks[?][lm_state2] = new_hypothesis2
